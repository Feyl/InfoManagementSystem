...
<form class="ui form" action="/adminController">
    <input type="hidden" name="method" value="chanPass">
    <div class="field" id="passInput">
        <label>New Password</label>
        <input type="text" name="newPass">
        <button class="ui facebook fluid button" type="submit" style="margin-top: 10px;">提交</button>
    </div>
</form>
